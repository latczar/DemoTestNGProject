...
public class Test_Assessment_assertValidationStatementEnabled extends TestListener {
	...
	*/
	...
	public Test_Assessment_assertValidationStatementEnabled() throws IOException {
		super();
	}
