...
public class Test_createAsset_Community extends TestListener {
	...
	*/
	...
	public Test_createAsset_Community() throws IOException {
		super();
	}
	...
	*/
	...
	public void Test_createAssetCommunity() throws Exception {
		loginPage.Login();
		createAsset.createAsset_Community("test123###"); // Start Asset creation - Community
	}
