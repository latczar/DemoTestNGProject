...
public class Test_Assessment_answeringQuestionsMinimumStandard extends TestListener {
	...
	*/
	...
	public Test_Assessment_answeringQuestionsMinimumStandard() throws IOException {
		super();
	}
